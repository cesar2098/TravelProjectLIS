...
<td class="lefttxt"><table border="0" width="100px" height="200px"><td>Nombre de usuario</td></td><td><input type="text" name="t1" required pattern="[a-zA-z _]{1,50}" title"Ingrese solo caracteres entre 1 y 50 para el nombre de usuario" /></td></tr>
<tr><td class="lefttxt">Contraseña&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="password" name="t2" required pattern="[a-zA-z0-9]{1,10}" title"Ingrese solo caracteres entre 1 y 10 para la contraseña" /></td></tr></table>
