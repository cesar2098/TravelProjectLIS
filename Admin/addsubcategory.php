...
<tr><td colspan="2" class="toptd">Agregar Subcategoría</td></tr>
<tr><td class="lefttxt">Nombre de Subcategoría</td><td><input type="text" name="t1" required pattern="[a-zA-z _]{2,50}" title"Ingrese solo caracteres entre 2 y 50 para el nombre de la subcategoría"/></td></tr>
<tr><td class="lefttxt">Seleccionar Subcategoría</td><td><select name="t2" required/><option value="">Seleccionar</option>
...
<tr><td class="lefttxt">Subir Fotos</td><td><input type="file" name="t3" /></td></tr>
