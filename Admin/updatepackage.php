...
<tr><td colspan="2" class="toptd">Paquete de actualización</td></tr>
...
<tr><td class="lefttxt">Package Name</td><td><input type="text"  value="<?php if(isset($_POST["show"])){ echo $Packname ;} ?> " name="t1" required pattern="[a-zA-z _]{1,50}" title"Ingrese solo caracteres entre 1 y 50 para el nombre del paquete"/></td></tr>
<tr><td class="lefttxt">selecciona una categoría</td><td><select name="t2" required/><option value="">Seleccionar</option>
...
<tr><td class="lefttxt">Seleccionar subcategoría</td><td><select name="t3" required/><option value="">Seleccionar</option>
...
<tr><td class="lefttxt">Seleccionar subcategoría</td><td><input type="text" name="t8" value="<?php if(isset($_POST["show"])){ echo $Packprice ;} ?> " /></td></tr>

<tr><td class="lefttxt">Foto vieja</td><td><img src="packimages/<?php echo @$Pic1; ?>" width="150px" height="50px" />
...
<tr><td class="lefttxt">Foto vieja</td><td><img src="packimages/<?php echo @$Pic2; ?>" width="150px" height="50px" />
...
<tr><td class="lefttxt">Foto vieja</td><td><img src="packimages/<?php echo @$Pic3; ?>" width="150px" height="50px" />
